...
<b> 2.1. linux/MaxOS&nbsp;&nbsp;&nbsp;   [Download](https://github.com/BGI-shenzhen/LDBlockShow/archive/v1.32.tar.gz) </b>
...
```php
 ./bin/LDBlockShow
        ...
        Usage: LDBlockShow  -InVCF  <in.vcf.gz>  -OutPut <outPrefix>  -Region  chr1:10000-20000
                ...
                -help                      Show more Parameters and help [hewm2008 v1.32]
...
# [-SeleVar 1] is D'  , [-SeleVar 2]  is RR . # the default is D'
</pre>
